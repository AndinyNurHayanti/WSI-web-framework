...
<head>
  ...
  <link href="{{ asset('frontend/assets/vendor/icontfont/iconfont.min.css')}}" rel="stylesheet">
  ...
  <link href="{{ asset('frontend/assets/vendor/owl.caraousel/asset/owl.caraousel.min.css')}}" rel="stylesheet">
